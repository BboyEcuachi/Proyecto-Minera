...
<div class="jumbotron masthead">
  <div class="splash"> <img src="public/img/Portada1.jpg" alt=""> </div>
  <div class="splash"> <img src="public/img/Portada2.jpg" alt=""> </div>
  <div class="splash"> <img src="public/img/Portada3.jpg" alt=""> </div>
  ...
  <div class="container show-case-item">
    <span style="font-size: 180px; line-height: normal;"> MAD</span>
    <p></p><h1>Comercializadora MAD S.A</h1></p>
    <a href="#" class="bigbtn"> Contactanos! </a>
    <div class="clearfix"> </div>
  </div>
  <div class="container show-case-item">
    <h1>La simplicidad es algo bueno<br></h1>
    <p>Reciclando la simplicidad y eficacia de los telefonos del siglo pasado. CATI entrega un servicio de llamado que emula a su homologo del siglo con anterior</p>
    <a href="#" class="bigbtn"> Contactanos! </a>
    <div class="clearfix"> </div>
  </div>
  <div class="container show-case-item">
    <h1> Connectividad rápida y eficaz <br></h1>
    <p> Con tecnología de punto y con apoyo de la mundialmente conocida aplicación Skype. CATI entrega un servicio eficaz logrando una real conectividad a nivel mundial.</p>
    <a href="#" class="bigbtn"> Contactanos! </a>
    <div class="clearfix"> </div>
  </div>
  <div id="banner-pagination">
    <ul>
      <li><a href="#" class="active" rel="0"> <img src="public/img/slidedot-active.png" alt=""></a></li>
      <li><a href="#" rel="1"> <img src="public/img/slidedot.png" alt=""></a></li>
      <li><a href="#" rel="2"> <img src="public/img/slidedot.png" alt=""></a></li>
    </ul>
  </div>
</div>
<div class="container">
  <div class="marketing">
    ...
    <hr class="soften">
    <div class="row-fluid">
      <div class="span4"> <img src="public/img/responsive.png" alt="">
        <h2> <span class="firstword"> Proyecto mas popular o relevante </span> Layout</h2>
        <p class="features"> El pasado 12 de febrero del 2017 se llevo a cabo uno de los proyectos mas relveante para nosotros...
          <a href="#" > mas </a>
        </p>
      </div>
      <div class="span4"> <img src="public/img/think-creative.png" alt="">
        <h2> <span class="firstword"> Cliente mas relevante </span> </h2>
        <p> Junto a la USM y sus excelentes alumnos hemos realizado grandes proyectos, como...<a href="#"> mas </a> </p>
      </div>
      <div class="span4"> <img src="public/img/core-values.png" alt="">
        <h2> <span class="firstword"> Nos inspira </span></h2>
        <p> La creatividad y motivacion ......<a href="#"> mas </a> </p>
      </div>
    </div>
    <hr class="soften">
  </div>
    ...
    <div class="row-fluid">
      ...
      <div class="span3 MT70">
        ...
        <ul class="footer_social clearfix">
          <li><a href="https://www.facebook.com/Comercializadora-Mad-969422829861134/" class="footer_facebook">Facebook</a></li>
