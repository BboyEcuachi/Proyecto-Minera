...
<div class="page-header text-center" align="center">
    <h1>Equipo de Trabajo<br></h1>
</div>
<div class="page-header text-center" align="center">
    <table>
        <td>
            <table>
                <td><img src="../public/img/Felipe Villagran L..jpg" alt="" border=3 height=300 width=300></td>
                <td style="vertical-align:middle">Felipe Villagran <br> Ingeniero de Proyectos</td>
            </table>
        </td>
        <td>
            <table>
                <td><img src="../public/img/Jorge Herrera G..jpg" alt="" border=3 height=300 width=300></td>
                <td style="vertical-align:middle">Felipe Villagran <br> Ingeniero de Proyectos</td>
            </table>
        </td>

        <td><img src="../public/img/Roberto Sánchez I..jpg" alt="" border=3 height=300 width=300></td>
        <td style="vertical-align:middle">Roberto Sánchez <br> Proyectista trolo</td>
    </table>
</div>
>
<footer class="footer">
